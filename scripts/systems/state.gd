...
# A static reference to the Player node, shared across all state instances.
# This lets every state know about the Guardian, making it easy to control their actions!
static var player: Player

# Called when the state is initialized or entered.
# Add setup code here, like preparing the Guardian for a new task in the forest!
func _ready():
	pass
